...
/**
 * Implementa un programa que reciba
 *
 * el nombre de un directorio
 *
 * y los 4 primeros caracteres por los que deben comenzar un grupo de ficheros (por ejemplo "PRO_*).
 *
 *
 * Para cada uno de los archivos contenidos en dicho directorio
 * cuyo nombre comience por la cadena indicada,
 *
 ...
 *
 * Si tienen permisos de escritura y de lectura
 * d.
 * Su tamaño en KB.
 */
public class ej1 {
